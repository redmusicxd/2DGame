...
public class LevelGeneration : MonoBehaviour {
    ...
    public bool Stop { get{ return stopGeneration; } set{ stopGeneration = value; }}
    ...
    private void Start()
    {
        randStarting = Random.Range(0, startingPositions.Length);
    ...
    private void Update()
    {
        ...
        {
            player.transform.position = startingPositions[randStarting].position;
